...
///
/// [title] is the short human-readable label ("Failed to delete", etc.).
...
/// flashes an inline "Copied" confirmation for ~1.2s. Designed to drop
/// into existing dialog / InfoBar bodies without restructuring them.
///
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        ...
        Tooltip(
          message: _justCopied
              ? 'Copied in AI-paste format'
              : widget.reportTitle != null
              ? 'Copy title + details + version as markdown (ready to paste into an AI chat)'
              : 'Copy to clipboard',
          child: IconButton(
            icon: Icon(
